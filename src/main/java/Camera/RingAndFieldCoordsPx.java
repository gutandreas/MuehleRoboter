...
public class RingAndFieldCoordsPx {
    ...
    public RingAndFieldCoordsPx() {
        ...
        positionMap.put(new Position(0,5), new XyCoordsPx(1562+xBorder, 2317+yBorder));
        ...
        positionMap.put(new Position(1,4), new XyCoordsPx(800+xBorder, 1963+yBorder));
        positionMap.put(new Position(1,5), new XyCoordsPx(1556+xBorder, 1966+yBorder));
        positionMap.put(new Position(1,6), new XyCoordsPx(2323+xBorder, 1986+yBorder));
        positionMap.put(new Position(1,7), new XyCoordsPx(2317+xBorder, 1217+yBorder));

        positionMap.put(new Position(2,0), new XyCoordsPx(1932+xBorder, 842+yBorder));
        positionMap.put(new Position(2,1), new XyCoordsPx(1565+xBorder, 842+yBorder));
        positionMap.put(new Position(2,2), new XyCoordsPx(1192+xBorder, 838+yBorder));
        positionMap.put(new Position(2,3), new XyCoordsPx(1196+xBorder, 1205+yBorder));
        positionMap.put(new Position(2,4), new XyCoordsPx(1186+xBorder, 1567+yBorder));
        positionMap.put(new Position(2,5), new XyCoordsPx(1555+xBorder, 1560+yBorder));
        positionMap.put(new Position(2,6), new XyCoordsPx(1933+xBorder, 1567+yBorder));
        positionMap.put(new Position(2,7), new XyCoordsPx(1935+xBorder, 1212+yBorder));
