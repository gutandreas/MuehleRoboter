...
public interface EbbCommand extends UbwCommand {
     ...
     *
     * @param duration a value from 1 to 65,535 and is in milliseconds. It represents
     ...
     * ms is executed.
     *
     * @param duration value from 1 to 65,535 and is in milliseconds. It represents
     *                 the total length of time you want this move to take.
     * @param axis1    value from -32,767 to +32,767 and represent the number of
     *                 steps for motor 1 to take in duration milliseconds.
     * @param axis2    value from -32,767 to +32,767 and represent the number of
     ...
     *
     * @param state <code>true</code> sets the pen down, <code>false</code> sets
     *              it up
     */
     ...
     *
     * @param channel    a number from 0 to 7 (with 0 as a special value, see below)
     * @param duration   a number from 0 to 32,000, and represents the 'on' time (0 =
     *                   0ms, 32,000 = 3ms)
     * @param output_pin a number from 0 to 24, and is the RPx pin number you want this
     *                   channel to come out on- see schematic for RPx numbers
     * @param rate       the rate at which to change from the current value to the new
     *                   value
     */
